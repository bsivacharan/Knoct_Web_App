        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">Scan the QR code with Knoct app</p>
              <div class="text-center">
                ...
                <p class="login-card-footer-text">Already have credentials <a href="#!" class="text-reset">Login here</a></p>
				 <div id="dots">
				 <form id="creds" method="post" action="issuecreds.php">
					<input type="hidden" name="connid" id="connid" value=""> 
					<input type="hidden" name="conndid" id="conndid" value="">					
				</form> 
				 </div>
